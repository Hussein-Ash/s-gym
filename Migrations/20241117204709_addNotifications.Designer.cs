...
namespace EvaluationBackend.Migrations
{
    ...
    [Migration("20241117204709_addNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EvaluationBackend.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2024, 11, 17, 20, 47, 9, 346, DateTimeKind.Utc).AddTicks(6556),
                            Deleted = false,
                            Password = "12345678",
                            PhoneNumber = "07816565518",
                            Role = 0,
                            SubId = new Guid("00000000-0000-0000-0000-000000000000"),
                            UserName = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("EvaluationBackend.Entities.Notification", b =>
                {
                    b.HasOne("EvaluationBackend.Entities.AppUser", "Resever")
                        .WithMany()
                        .HasForeignKey("ReseverId");

                    b.HasOne("EvaluationBackend.Entities.AppUser", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderId");

                    b.Navigation("Resever");
